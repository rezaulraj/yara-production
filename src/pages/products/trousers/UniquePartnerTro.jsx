...
import partner1 from "../../../assets/image/menufuture/Production/trousers/trouser1.jpg?url";
import partner2 from "../../../assets/image/menufuture/Production/trousers/trouser2.jpg?url";

const UniquePartnerTro = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h2 className="text-4xl font-serif font-medium text-gray-800 leading-tight">
              Your Partner in Fashion Innovation
            </h2>
            <p className="text-gray-600 leading-relaxed">
              Yara Production collaborates with top brands globally, leveraging
              our design and production capabilities to create original,
              high-quality collections. Our designers stay ahead of the curve,
              infusing the latest fashion trends and innovations into our
              knitted products. The result? Exceptional collections that elevate
              the presence of our partner brands worldwide.
            </p>
...
export default UniquePartnerTro;
