...
import partner1 from "../../../assets/image/menufuture/Production/tracksuit/ts1.jpg?urll";
import partner2 from "../../../assets/image/menufuture/Production/tracksuit/ts2.jpg?url";

const UniquePartnerTr = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              infusing the latest trends and innovations into our products. The
              result? Exceptional collections that adorn the showcases of the
              world's most esteemed brands.
            </p>
...
export default UniquePartnerTr;
