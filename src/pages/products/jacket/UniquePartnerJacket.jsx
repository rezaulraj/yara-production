...
import partner1 from "../../../assets/image/menufuture/Production/jacket/c1.jpg?url";
import partner2 from "../../../assets/image/menufuture/Production/jacket/c2.jpg?url";

const UniquePartnerJa = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h2 className="text-4xl font-serif font-medium text-gray-800 leading-tight">
              Partner of Worldwide Brands
            </h2>

            <h4 className="text-xl font-serif font-medium text-gray-800 leading-tight mt-4">
              Innovative Design, Exceptional Quality
            </h4>
            <p className="text-gray-600 leading-relaxed">
              Yara Production leverages its production expertise to craft
              original collections for esteemed local and international brands.
              Our in-house design center, driven by trend-savvy designers,
              delivers cutting-edge knitted products, fabrics, and prints that
              showcase innovation and style.
            </p>
            <h4 className="text-xl font-serif font-medium text-gray-800 leading-tight mt-4">
              Elevating Global Brands
            </h4>
            <p className="text-gray-600 leading-relaxed">
              Our high-quality collections adorn the showcases of valued brands
              worldwide, reflecting our commitment to excellence and fashion
              expertise.
            </p>
...
export default UniquePartnerJa;
