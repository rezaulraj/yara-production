...
import partner1 from "../../../assets/image/menufuture/Production/collarshirts/s1.jpg?url";
import partner2 from "../../../assets/image/menufuture/Production/collarshirts/s2.jpg?url";
const UniqurePartnerColors = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              YARA Production leverages its design and production expertise to
              create original collections for top brands globally. Our in-house
              design center, driven by trend-savvy designers, produces
              innovative knitted products, fabrics, and prints that showcase
              style and excellence.
            </p>

            <h4 className="text-xl font-serif font-medium text-gray-800 leading-tight">
              Elevating Brand Presence
            </h4>
            <p className="text-gray-600 leading-relaxed">
              Our high-quality collections adorn the showcases of esteemed
              brands worldwide, reflecting our commitment to fashion innovation
...
export default UniqurePartnerColors;
