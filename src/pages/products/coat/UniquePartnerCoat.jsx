        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Yara Production empowers local and international brands with
              cutting-edge design and production capabilities. Our in-house
              design center, driven by trend-savvy designers, crafts original
              collections featuring innovative knitted products, fabrics, and
              prints.
            </p>
            <h4 className="text-xl font-serif font-medium text-gray-800 leading-tight mt-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              global brands, reflecting our commitment to fashion excellence and
...
export default UniquePartnerCoat;
