...
import partner1 from "../../assets/image/menufuture/AboutUs/1.jpg?url";
import partner2 from "../../assets/image/menufuture/AboutUs/2.jpg?url";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              production-to-design expertise. Our in-house design center,
              staffed by trend-savvy designers, creates original collections
              featuring:
            </p>
            <ul className="text-gray-600 space-y-2 pl-5">
              <li className="relative before:absolute before:-left-5 before:top-2 before:w-2 before:h-2 before:bg-amber-600 before:rounded-full">
                Latest innovations in knitted products
              </li>
              <li className="relative before:absolute before:-left-5 before:top-2 before:w-2 before:h-2 before:bg-amber-600 before:rounded-full">
                Diverse fabrics and prints
              </li>
            </ul>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              global brands, reflecting our commitment to excellence and
              attention to detail.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {partnerImages.map((image, index) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-black/20 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
